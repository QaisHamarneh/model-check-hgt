...
# game, termination_conditions, queries = parse_game("examples/simple_game.json")

game, termination_conditions, queries = parse_game("examples/3_players_1_ball.json")

# properties = get_all_properties(queries)

println("termination_conditions: ", termination_conditions)
...
game_tree::Node = build_triggers_game_tree(game, Set{Constraint}(), termination_conditions)
